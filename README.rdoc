...
1. generic declaration
  ...
  assets_upload(:my_key, {optional_option_hash})
  assetable.papermill_assets(:key => :my_key)

2. association declaration

  papermill :my_association, {my_option_hash}
  assets_upload(my_association, {optional_option_hash})
