...
1. Ajax uploading form helpers through SWFUpload: 
...
2. choose thumbnail size for images previews : 
...
5. Alias handling, declaration application-wide
...
6. Nice-looking URLs: /system/papermill/000/000/001/my_alias/my-image-name.jpg
