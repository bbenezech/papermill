...
=== Then in environment.rb:
  ...
  Rails::Initializer.run do |config|
    ...
    ...
    # You can use Mime-Type to get the correct mime type from upload - flash garbles it.. 
    # default to a UNIX call to "file --mime" that works fine,
    # but mime-types is needed for Windows OS (it will get the mime from extension):
