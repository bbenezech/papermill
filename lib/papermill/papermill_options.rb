module Papermill
  BASE_OPTIONS = {
    ...
    :copyright_im_command => "-gravity south-west -font Arial -pointsize 20 -fill white -annotate +20+20 '%s'",
    :watermark => "http://www.imagemagick.org/Usage/resize/rings_sm_orig.gif",
    #:watermark_im_command => " %s -compose dissolve -set option:compose:args 30 -composite ",
    :watermark_im_command => %{- | composite \\( %s -resize 50% \\) - -dissolve 25% -gravity north-east -geometry +10+10},
